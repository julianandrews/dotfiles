...
pass show diana/google/ical-address | systemd-creds encrypt --user --name=calendar-sync-diana-ical-address - ~/.config/credstore.encrypted/calendar-sync-diana-ical-address.cred
