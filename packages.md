...
git mercurial python python-dev python3 python3-dev cython libperl-dev ruby ruby-dev python-flake8 python-xdg python-xmpp python3-dbus flake8 default-jre postgresql postgresql-server-dev-all sqlite exuberant-ctags postgis hlint rustc cargo
