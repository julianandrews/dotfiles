...
CLI tools
---------:
git curl checkinstall htop tree pv jq p7zip-full unzip unrar pm-utils apg scrot imagemagick gnupg nmap zip screen libav-tools ecryptfs-utils exfat-utils
