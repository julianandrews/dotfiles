...
CLI tools
---------
apg at bash-completion curl ffmpeg git htop imagemagick jq locate neovim nmap p7zip-full pv ripgrep sqlite unrar-free unzip zip rsync git-lfs dnsutils msmtp libsecret-tools
