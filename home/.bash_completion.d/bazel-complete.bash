...
BAZEL_COMMAND_LIST="analyze-profile aquery build canonicalize-flags clean coverage cquery dump fetch help info license mobile-install print_action query run shutdown sync test version"
BAZEL_INFO_KEYS="
workspace
install_base
output_base
...
--noexperimental_json_trace_compression
...
--noincompatible_package_name_is_a_function
--incompatible_range_type
--noincompatible_range_type
--incompatible_remove_native_git_repository
--noincompatible_remove_native_git_repository
--incompatible_remove_native_http_archive
--noincompatible_remove_native_http_archive
--incompatible_static_name_resolution
--noincompatible_static_name_resolution
...
--noexperimental_disable_compilation_mode_flags
--experimental_disable_legacy_cc_compilation_api
--noexperimental_disable_legacy_cc_compilation_api
--experimental_disable_legacy_cc_linking_api
--noexperimental_disable_legacy_cc_linking_api
--experimental_disable_legacy_crosstool_fields
--noexperimental_disable_legacy_crosstool_fields
--experimental_disable_linking_mode_flags
--noexperimental_disable_linking_mode_flags
...
--noexperimental_enable_cc_toolchain_config_info
...
--experimental_multi_threaded_digest
--noexperimental_multi_threaded_digest
--experimental_no_dotd_scanning_with_modules
--noexperimental_no_dotd_scanning_with_modules
...
--experimental_prune_cpp_input_discovery
--noexperimental_prune_cpp_input_discovery
...
--java_classpath={off,javabuilder}
--java_debug
--java_deps
--nojava_deps
