...
# History:
#
# 2015-10-21, Julian Andrews <jandrews271@gmail.com
#     version 0.1 of i3lock_away (mostly s/slock/i3lock/g on
#     Peter A. Shevtsov's code)
#
# 2011-10-14, Peter A. Shevtsov <pshevtsov@severusweb.ru>:
#     initial release of slock_away
#
